                ...
                <div className="flex items-center gap-1.5">
                    <div className="relative">
                        ...
                        <Input
                            ...
                            className="pl-8 w-36 md:w-44 bg-muted/50 border-0 h-8 text-xs"
                        />
                    </div>
                    <div className="flex border border-border rounded-lg overflow-hidden">
                        {viewButtons.map(v => (
                            <button
                                ...
                                className={cn("p-1.5 transition-colors", view === v.id ? "bg-primary text-primary-foreground" : "hover:bg-muted")}
                                title={v.label}
                            >
                    ...
                    <Button variant="outline" size="sm" className="h-8 w-8 p-0" onClick={() => setShowTemplates(!showTemplates)} title="Templates">
                        <Zap className="w-3.5 h-3.5" />
                    </Button>
                    <Button size="sm" className="gradient-primary text-white h-8" onClick={() => setShowQuickCreate(true)}>
